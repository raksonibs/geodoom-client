...
module.exports = function(environment) {
  ...
  if (environment === 'development') {
    ...
    ENV.contentSecurityPolicy = {
      "connect-src": "'self' ws://localhost:4000 http://badcomics.s3.amazonaws.com localhost:3000/*"
    }
  ...
  if (environment === 'test') {
    ...
    ENV.contentSecurityPolicy = {
      "connect-src": "'self' ws://protected-garden-47773.herokuapp.com http://badcomics.s3.amazonaws.com localhost:3000/*"
    }
  }
